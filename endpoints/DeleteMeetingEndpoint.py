...
from data.deleter.MeetingDeleter import MeetingDeleter
...
class DeleteMeetingEndpoint:
    ...
    def delete_meeting(self) -> Response:
        ...
        if self._user_role != ADMIN_ROLE_NAME:
            self._logger.error("Invalid Permissions to access this resource.")
        ...
        if self._endpoint_status:
            ...
            self._logger.info("Delete Started")
            return Response(True)

        self._logger.warning("Delete did not commence, either due to invalid role or a closed endpoint.")
